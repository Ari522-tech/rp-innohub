...
export default function Footer() {
  ...
  return (
    <footer className="bg-white border-t border-slate-200 text-slate-600">
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-5">
            ...
            <p className="text-sm leading-relaxed text-slate-600 max-w-xs">
              Connecting Rwanda Polytechnic innovators with institutions to develop socio-economic IT solutions.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              {[
                ...
                { to: '/calls', label: 'Calls for Projects' },
                { to: '/training', label: 'Training' },
                { to: '/about', label: 'About Us' },
                { to: '/contact', label: 'Contact' },
              ].map(item => (
                <li key={item.to}>
                  <Link to={item.to} className="text-slate-600 hover:text-blue-700 transition-colors">
                    {item.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:innovation@rp.ac.rw" className="hover:text-blue-700 transition-colors">
                  innovation@rp.ac.rw
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="h-4 w-4 text-blue-600 shrink-0" />
                <a href="tel:+250791100954" className="hover:text-blue-700 transition-colors">
                  +250 791 100 954
                </a>
              </li>
            </ul>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="flex gap-5">
                <a href="#" className="text-slate-500 hover:text-blue-700 transition-colors" aria-label="Facebook">
                  <Facebook className="h-5 w-5" />
                </a>
                <a href="#" className="text-slate-500 hover:text-blue-700 transition-colors" aria-label="LinkedIn">
                  <Linkedin className="h-5 w-5" />
                </a>
                <a href="#" className="text-slate-500 hover:text-blue-700 transition-colors" aria-label="Twitter">
      ...
      {/* Subtle bottom bar */}
      <div className="border-t border-slate-100 bg-slate-50 py-5 text-center">
